...
The Bitcoin OTC Web of Trust and ratings system has received somewhat more vocal criticism amongst those who have dealt with it, though it should really be considered the first step towards a more adaptable and robust system.  This is the intended successor to that system, hence the references to this one as version 2 and the existing rating system as version 1.
